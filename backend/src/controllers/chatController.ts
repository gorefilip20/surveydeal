...
router.post("/rooms", userAuth, validate(chatRoomCreateSchema), async (req: AuthRequest, res: Response) => {
  try {
...
router.get("/rooms", userAuth, async (req: AuthRequest, res: Response) => {
  try {
...
router.get("/rooms/:roomId/messages", userAuth, async (req: AuthRequest, res: Response) => {
  try {
...
router.post("/rooms/:roomId/messages", userAuth, validate(chatMessageSchema), async (req: AuthRequest, res: Response) => {
  try {
...
router.get("/admin/rooms", adminAuth, async (req: AuthRequest, res: Response) => {
  try {
...
router.patch("/admin/rooms/:roomId/close", adminAuth, async (req: AuthRequest, res: Response) => {
  try {
...
router.patch("/admin/rooms/:roomId/escalate", adminAuth, async (req: AuthRequest, res: Response) => {
  try {
    const room = await prisma.chatRoom.update({
      where: { id: req.params.roomId as string },
