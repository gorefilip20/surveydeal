      ...
      <nav className="sticky top-0 z-50 bg-bg border-b-2 border-divider">
        <div className="max-w-[1120px] mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-heading font-extrabold text-text">SurveyDeal</span>
            <span className="tag tag-accent ml-1">ESCROW</span>
          </Link>
          <div className="hidden sm:flex items-center gap-6">
            <Link href="/dashboard" className="text-sm font-semibold text-accent">Dashboard</Link>
            <Link href="/escrow/create" className="text-sm font-semibold text-text hover:text-accent transition-colors">Create</Link>
            <Link href="/admin" className="text-sm font-semibold text-text hover:text-accent transition-colors">Admin</Link>
          </div>
